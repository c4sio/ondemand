...
var tree_data = {
  'tv': {name: 'TV', type: 'folder'}
};

tree_data['tv']['additionalParameters'] = {
  'children': {
    'onDemand' : {
      name: 'On Demand',
      type : 'folder'
...
tree_data['tv']['additionalParameters']['children']['onDemand']['additionalParameters'] = {
  'children' : {
    'action' : {
      name : 'Ação',
      type : 'folder'
...
tree_data.tv.additionalParameters.children.outraChance.additionalParameters = {
  'children' : {
    'foxPlay' : {
      name : 'Fox Play',
      type : 'folder'
...
tree_data.tv.additionalParameters.children.outraChance.additionalParameters.children.foxPlay.additionalParameters = {
  'children' : {
    'simpsons' : {
      name : 'Simpsons',
      type : 'folder'
...
tree_data.tv.additionalParameters.children.outraChance.additionalParameters.children.globosatPlay.additionalParameters = {
  'children' : {
    'sportvPlay' : {
      name : 'SporTV Play',
      type : 'folder'
